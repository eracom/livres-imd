...
Voici quelques livres sur les thématiques Design UX et ergonomie des interfaces:
...
Le livre de Carine Lallemand, *Méthodes de design UX* fournit de nombreuses ressources pour la phase "Recherche UX". Ce pavé de 700 pages détaille 30 "Méthodes de design UX", avec des fiches orientées vers la pratique. Parmi les méthodes: *Brainstorming*, *Entretien*, *Persona*, *Tri de cartes*, *Tests utilisateurs*...

Quelques extraits:

![](images/ux/p310-personas.jpg)
